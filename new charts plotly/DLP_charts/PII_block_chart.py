...
# Filter only the required policies
df = df[df["Policy"].isin(["BAGIC - PII Policy", "BAGIC - PII Policy (2)"])]

def detailed_PII_block_data_charts():
...
includes application blocks, usb , Bluetooth etc.</li>
    </ul>
    """, """<ul>
