...
df = pd.read_excel("health_motor_renewal_pass_data.xlsx")

def health_motor_renewal_pass_data_charts():
...
<li>Endpoint- This includes the data at the Endpoint device itself, this
includes application blocks, usb, Bluetooth, Print etc.</li>
    ...
    """,
      ...
      <li>Health Renewal Policy allows to pass single attahment.</li>
      <li>Motor Renewal Policy is just monitor Policy</li>
    ...
    """
    <ul>
      <li>Top 50 senders successfully sending data outside.</li>
